...
where OS.Index: Hashable {
  ...
  // CHECK-SAME: id #OverridesSetter.subscript!getter.uncurried
...
// CHECK: witness_method $OS, #OriginalGetter.subscript!getter.uncurried

// CHECK-LABEL: sil shared [thunk] @$s18protocol_overrides10AddsSetterPy7ElementQz5IndexQzcipAA09OverridesD0RzSHAGRQlxxTk
// CHECK-LABEL: witness_method $OS, #AddsSetter.subscript!setter.uncurried
