...
// CHECK-NEXT: [[T0:%.*]] = class_method [[ARG]] : $A, #A.array!getter.uncurried
...
// CHECK-NEXT: [[T0:%.*]] = class_method [[ARG]] : $A, #A.array!modify.uncurried
...
// CHECK-NEXT: [[INDEX1:%.*]] = apply [[T0]]()
//   Formal access to RHS.
// CHECK-NEXT: [[T0:%.*]] = class_method [[ARG]] : $B, #B.array!modify.uncurried
