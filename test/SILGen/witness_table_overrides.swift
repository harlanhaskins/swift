...
func callFoo<T: P3>(t: T) {
  // CHECK: witness_method $T, #P0.foo.uncurried : <Self where Self : P0> (Self) -> () -> ()
  t.foo()
}
...
// CHECK-NEXT:    method #P0.foo.uncurried: <Self where Self : P0> (Self) -> () -> () : @$s23witness_table_overrides2X3VAA2P0A2aDP3fooyyFTW
// CHECK-NEXT:  }
