...
func optionalMethodGeneric<T : P1>(t t : T) {
  ...
  // CHECK:   dynamic_method_br [[T]] : $T, #P1.method.uncurried.foreign
...
func optionalPropertyGeneric<T : P1>(t t : T) {
  ...
  // CHECK:   dynamic_method_br [[T]] : $T, #P1.prop!getter.uncurried.foreign
...
func optionalSubscriptGeneric<T : P1>(t t : T) {
  ...
  // CHECK:   alloc_stack $Optional<Int>
  // CHECK:   dynamic_method_br [[T]] : $T, #P1.subscript!getter.uncurried.foreign
