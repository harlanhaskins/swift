...
func computedProperties<T: P>(_: T) {
  ...
  // CHECK-SAME:   id #C.nonfinal!getter.uncurried : <T> (C<T>) -> () -> S<T>,
  ...
  // CHECK-SAME:   id #C.computed!getter.uncurried : <T> (C<T>) -> () -> S<T>,
  ...
  // CHECK-SAME: root $C<τ_0_0>;
  // CHECK-SAME: settable_property $S<τ_0_0>, 
  // CHECK-SAME:   id #C.observed!getter.uncurried : <T> (C<T>) -> () -> S<T>,
  ...
  // CHECK-SAME:   id #P.x!getter.uncurried : <Self where Self : P> (Self) -> () -> Int,
  ...
  // CHECK-SAME:   id #P.y!getter.uncurried : <Self where Self : P> (Self) -> () -> String,
...
func keyPathForStorageQualified() {
  ...
  // CHECK-SAME: settable_property $Optional<StorageQualified>, id #StorageQualified.tooWeak!getter.uncurried
  _ = \StorageQualified.tooWeak
  // CHECK: = keypath $ReferenceWritableKeyPath<StorageQualified, StorageQualified>,
  // CHECK-SAME: settable_property $StorageQualified, id #StorageQualified.disowned!getter.uncurried
