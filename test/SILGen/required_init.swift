...
// CHECK:         class_method {{%.*}} : $@thick Foo.Type, #Foo.init!allocator.uncurried
...
// CHECK:         #Foo.init!allocator.uncurried: {{.*}} : @$s13required_init3FooC{{[_0-9a-zA-Z]*}}fC

// CHECK-LABEL: sil_vtable Bar {
// CHECK:         #Foo.init!allocator.uncurried: {{.*}} : @$s13required_init3BarC{{[_0-9a-zA-Z]*}}fC
