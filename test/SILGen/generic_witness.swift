...
func foo<B : Runcible>(_ x: B) {
  // CHECK: [[METHOD:%.*]] = witness_method $B, #Runcible.runce.uncurried : {{.*}} : $@convention(witness_method: Runcible) <τ_0_0 where τ_0_0 : Runcible><τ_1_0> (@in_guaranteed τ_1_0, @in_guaranteed τ_0_0) -> ()
...
func bar(_ x: Runcible) {
  ...
  // CHECK: [[METHOD:%.*]] = witness_method $[[OPENED]], #Runcible.runce.uncurried
