...
// CHECK: switch_enum [[ARG]] : $Optionable<(A) -> A>, case #Optionable.Summn!enumelt.uncurried: [[DEST:bb[0-9]+]]
//
...
// CHECK: switch_enum_addr [[ENUM:%.*]] : $*Wacky<T, A>, {{.*}} case #Wacky.Bar!enumelt.uncurried: [[DEST:bb[0-9]+]]
// CHECK: [[DEST]]:
