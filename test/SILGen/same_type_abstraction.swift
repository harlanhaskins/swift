...
extension MyProtocol where Data == (ReadData, ReadData) {
  ...
  func currentData() -> Data {
    ...
    // CHECK:   [[READ_FN:%.*]] = witness_method $Self, #MyProtocol.readData.uncurried : {{.*}} : $@convention(witness_method: MyProtocol) <τ_0_0 where τ_0_0 : MyProtocol> (@in_guaranteed τ_0_0) -> @out τ_0_0.ReadData
