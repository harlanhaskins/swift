...
// CHECK-NEXT:   #Base.foo.uncurried: {{.*}} : @$s4main10PrivateSub33_{{.*}}3fooyyF
// CHECK-NEXT:   #Base.init!allocator.uncurried: {{.*}} : @$s4main10PrivateSub33_{{.*}}ADycfC
// CHECK-NEXT:   #PrivateSub.deinit!deallocator.uncurried: @$s4main10PrivateSub33_{{.*}}fD
// CHECK-NEXT: }
