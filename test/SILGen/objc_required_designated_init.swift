...
// CHECK-NOT: #Boom.init!allocator.uncurried: (Boom.Type) -> () -> Boom : @$s29objc_required_designated_init6BaboomCACycfC [override]
// CHECK:     #Baboom.deinit!deallocator.uncurried: @$s29objc_required_designated_init6BaboomCfD
// CHECK: }

// CHECK-LABEL: sil_vtable BigBadaBoom {
// CHECK-NOT: #Badaboom.init!allocator.uncurried
// CHECK:     #BigBadaBoom.deinit!deallocator.uncurried: @$s29objc_required_designated_init11BigBadaBoomCfD
// CHECK: }

// CHECK-LABEL: sil_vtable Root {
// CHECK-NOT: #Root.init!allocator.uncurried
// CHECK:     #Root.deinit!deallocator.uncurried: @$s29objc_required_designated_init4RootCfD
// CHECK: }
