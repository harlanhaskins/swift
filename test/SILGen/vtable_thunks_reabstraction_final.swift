...
// CHECK:         class_method {{%.*}} : $NongenericSub, #NongenericSub.foo.uncurried {{.*}}, $@convention(method) (@in_guaranteed Int, @guaranteed NongenericSub) -> @out Optional<Int>
...
// CHECK:         class_method {{%.*}} : $GenericSub<τ_0_0>, #GenericSub.foo.uncurried {{.*}}, $@convention(method) <τ_0_0 where τ_0_0 : AnyObject> (@in_guaranteed τ_0_0, @guaranteed GenericSub<τ_0_0>) -> @out Optional<τ_0_0>
...
func test() {
  ...
  // CHECK:         class_method {{%.*}} : $GenericSub<C>, #GenericSub.foo.uncurried {{.*}}, $@convention(method) <τ_0_0 where τ_0_0 : AnyObject> (@in_guaranteed τ_0_0, @guaranteed GenericSub<τ_0_0>) -> @out Optional<τ_0_0>
  GenericSub<C>().foo(C())
}
