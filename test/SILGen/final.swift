...
// CHECK-NEXT:  #TestClass.baseMethod.uncurried: {{.*}} : @$s5final9TestClassC10baseMethod{{[_0-9a-zA-Z]*}}F
// CHECK-NEXT:  #TestClass.init!allocator.uncurried: {{.*}} : @$s5final9TestClassC{{[_0-9a-zA-Z]*}}fC
...
// CHECK-NEXT:  #TestClass.baseMethod.uncurried: {{.*}} : @$s5final11TestDerivedC10baseMethod{{[_0-9a-zA-Z]*}}F
// CHECK-NEXT:  #TestClass.init!allocator.uncurried: {{.*}} : @$s5final11TestDerivedC{{[_0-9a-zA-Z]*}}fC
