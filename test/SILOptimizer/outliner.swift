...
// CHECK:   %2 = objc_method %1 : $Gizmo, #Gizmo.stringProperty!getter.uncurried.foreign : (Gizmo) -> () -> String?
// CHECK:   %3 = apply %2(%1) : $@convention(objc_method) (Gizmo) -> @autoreleased Optional<NSString>
// CHECK:   switch_enum %3 : $Optional<NSString>, case #Optional.some!enumelt.uncurried: bb1, case #Optional.none!enumelt: bb2
...
// CHECK:   %10 = enum $Optional<String>, #Optional.some!enumelt.uncurried, %8 : $String
...
// CHECK: bb0(%0 : $Gizmo):
// CHECK:  %1 = objc_method %0 : $Gizmo, #Gizmo.stringProperty!getter.uncurried.foreign : (Gizmo) -> () -> String?
// CHECK:  %2 = apply %1(%0) : $@convention(objc_method) (Gizmo) -> @autoreleased Optional<NSString>
// CHECK:  switch_enum %2 : $Optional<NSString>, case #Optional.some!enumelt.uncurried: bb1, case #Optional.none!enumelt: bb2
...
// CHECK:  %9 = enum $Optional<String>, #Optional.some!enumelt.uncurried, %7 : $String
...
// CHECK:   %2 = objc_method %1 : $Gizmo, #Gizmo.stringProperty!setter.uncurried.foreign : (Gizmo) -> (String?) -> ()
...
// CHECK:   %6 = enum $Optional<NSString>, #Optional.some!enumelt.uncurried, %4 : $NSString
...
// CHECK:   %4 = objc_method %3 : $Gizmo, #Gizmo.modifyString.uncurried.foreign : (Gizmo) -> (String?, Int, Any?) -> String?
...
// CHECK:   release_value %0 : $String
// CHECK:   %8 = enum $Optional<NSString>, #Optional.some!enumelt.uncurried, %6 : $NSString
...
// CHECK:   switch_enum %9 : $Optional<NSString>, case #Optional.some!enumelt.uncurried: bb2, case #Optional.none!enumelt: bb1
//
// CHECK: bb1:
// CHECK:   %12 = enum $Optional<String>, #Optional.none!enumelt
// CHECK:   br bb3(%12 : $Optional<String>)
...
// CHECK:   %19 = enum $Optional<String>, #Optional.some!enumelt.uncurried, %17 : $String
...
// CHECK:   %2 = objc_method %1 : $Gizmo, #Gizmo.doSomething.uncurried.foreign : (Gizmo) -> ([String]?) -> Any?
...
// CHECK:   %6 = enum $Optional<NSArray>, #Optional.some!enumelt.uncurried, %4 : $NSArray
