...
class Grandchild : Child {
  class func onlyInGrandchild() {
    ...
    // CHECK-NOT: super_method %0 : $@thick Grandchild.Type, #Parent.onlyInParent.uncurried : Parent.Type -> () -> (), $@convention(method) (@thick Parent.Type) -> (){{.*}} // user: %5
  ...
  override class func foo() {
    ...
    // CHECK-NOT: super_method %0 : $@thick Grandchild.Type, #Parent.foo.uncurried : Parent.Type -> () -> (), $@convention(method) (@thick Parent.Type) -> ()
