...
// CHECK-NEXT: internal var _: Swift.Int64{{$}}
// RESILIENT-NOT: internal var _: Swift.Int64{{$}}
  var internalVar: Int64

// CHECK-NEXT: internal let _: Swift.Bool{{$}}
// RESILIENT-NOT: internal let _: Swift.Bool{{$}}
...
// CHECK-NEXT: private var _: Swift.Int64{{$}}
// RESILIENT-NOT: private var _: Swift.Int64{{$}}
  private var privateVar: Int64

// CHECK-NEXT: private let _: Swift.Bool{{$}}
// RESILIENT-NOT: private let _: Swift.Bool{{$}}
