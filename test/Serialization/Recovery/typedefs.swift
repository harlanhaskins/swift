...
// 10 CHECK-VTABLE-NEXT: #User.unwrappedProp!getter.uncurried:
// 11 CHECK-VTABLE-NEXT: #User.unwrappedProp!setter.uncurried:
// 12 CHECK-VTABLE-NEXT: #User.unwrappedProp!modify.uncurried:
// 13 CHECK-VTABLE-NEXT: #User.wrappedProp!getter.uncurried:
// 14 CHECK-VTABLE-NEXT: #User.wrappedProp!setter.uncurried:
// 15 CHECK-VTABLE-NEXT: #User.wrappedProp!modify.uncurried:
// 16 CHECK-VTABLE-NEXT: #User.returnsUnwrappedMethod.uncurried:
// 17 CHECK-VTABLE-NEXT: #User.returnsWrappedMethod.uncurried:
// 18 CHECK-VTABLE-NEXT: #User.constrainedUnwrapped.uncurried:
// 19 CHECK-VTABLE-NEXT: #User.constrainedWrapped.uncurried:
// 20 CHECK-VTABLE-NEXT: #User.subscript!getter.uncurried:
// 21 CHECK-VTABLE-NEXT: #User.subscript!getter.uncurried:
// 22 CHECK-VTABLE-NEXT: #User.init!allocator.uncurried:
// 23 CHECK-VTABLE-NEXT: #User.init!allocator.uncurried:
// 24 CHECK-VTABLE-NEXT: #User.init!allocator.uncurried:
// 25 CHECK-VTABLE-NEXT: #User.init!allocator.uncurried:
// 26 CHECK-VTABLE-NEXT: #User.lastMethod.uncurried:
// CHECK-VTABLE: }
