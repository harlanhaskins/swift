...
// CHECK-NEXT:   #Class.firstMethod.uncurried: (Class.Type) -> () -> () : @$s28vtable_deserialization_input5ClassC11firstMethodyyFZ
// CHECK-NEXT:   #Class.secondMethod.uncurried: (Class.Type) -> () -> () : @$s28vtable_deserialization_input5ClassC12secondMethodyyFZ
// CHECK-NEXT:   #Class.thirdMethod.uncurried: (Class.Type) -> () -> () : @$s28vtable_deserialization_input5ClassC11thirdMethodyyFZ
// CHECK-NEXT:   #Class.deinit!deallocator.uncurried: @$s28vtable_deserialization_input5ClassCfD
// CHECK-NEXT: }

// OPT:      sil_vtable Class {
// OPT-NEXT:   #Class.firstMethod.uncurried: (Class.Type) -> () -> () : @$s28vtable_deserialization_input5ClassC11firstMethodyyFZ
// OPT-NEXT:   #Class.secondMethod.uncurried: (Class.Type) -> () -> () : @$s28vtable_deserialization_input5ClassC12secondMethodyyFZ
// OPT-NEXT:   #Class.thirdMethod.uncurried: (Class.Type) -> () -> () : @$s28vtable_deserialization_input5ClassC11thirdMethodyyFZ
// OPT-NEXT:   #Class.deinit!deallocator.uncurried: @$s28vtable_deserialization_input5ClassCfD
// OPT-NEXT: }
