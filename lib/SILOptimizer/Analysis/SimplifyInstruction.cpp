...
// Simplify:
//   %1 = unchecked_enum_data %0 : $Optional<C>, #Optional.Some!enumelt.uncurried
//   %2 = enum $Optional<C>, #Optional.Some!enumelt.uncurried, %1 : $C
...
SILValue InstSimplifier::visitSelectEnumInst(SelectEnumInst *SEI) {
  ...
  if (EI && EI->getType() == SEI->getEnumOperand()->getType()) {
    ...
    //   %27 = enum $Optional<Int>, #Optional.Some!enumelt.uncurried, %20 : $Int
    ...
    //                                         case #Optional.Some!enumelt.uncurried: %29
    // We will return %29.
